...
Revision ID: 8589493b8707
Revises: 
Create Date: 2024-05-11 21:08:49.484674
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('admin', 'moderator', 'standard', name='user_role_types'), nullable=False),
